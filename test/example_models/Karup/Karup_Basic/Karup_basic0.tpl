...
[MIKESHE_FLOWMODEL]
   ...
   [LandUse]
      ...
      [VEGETATION]
         ...
         [TIME_SERIES_2]
            ...
            GRIDCODEID = '2'
            GRIDCODE = 2
            FIXED_VALUE_LAI = __lu_Forest_LAI__
            FIXED_VALUE_RD = __lu_Forest_RD__
            TYPE = 1
            [TIME_SERIES_FILE_1]
               Touched = 1
               IsDataUsedInSetup = 0
         ...
         [TIME_SERIES_3]
            ...
            GRIDCODEID = '3'
            GRIDCODE = 3
            FIXED_VALUE_LAI = __lu_Shrubs_LAI__
            FIXED_VALUE_RD = __lu_Shrubs_RD__
            TYPE = 1
            [TIME_SERIES_FILE_1]
               Touched = 1
               IsDataUsedInSetup = 0
         ...
         [TIME_SERIES_4]
            ...
            GRIDCODEID = '4'
            GRIDCODE = 4
            FIXED_VALUE_LAI = __lu_Wetlands_LAI__
            FIXED_VALUE_RD = __lu_Wetlands_RD__
            TYPE = 1
            [TIME_SERIES_FILE_1]
               Touched = 1
               IsDataUsedInSetup = 0
   ...
   [Overland]
      ...
      OverlandGroundWaterExchangeOption = 0
   ...
   [SaturatedZone]
      ...
      [GeoLayersSZ]
         ...
         [Layer_1]
            ...
            [HorHydrCon]
               Touched = 1
               IsDataUsedInSetup = 1
               FixedValue = __sz_GeoLayersSZ_Layer_1_HorHydrCon__
               Type = 0
               ShapeAxisUnit = 1000
               ShapeGapFillName = ''
               InterpMethod = 2
            ...
            [VerHydrCon]
               Touched = 1
               IsDataUsedInSetup = 1
               FixedValue = __sz_GeoLayersSZ_Layer_1_VerHydrCon__
               Type = 0
               ShapeAxisUnit = 1000
               ShapeGapFillName = ''
               InterpMethod = 2
            ...
            [SpecificYield]
               Touched = 1
               IsDataUsedInSetup = 1
               FixedValue = __sz_GeoLayersSZ_Layer_1_SpecificYield__
               Type = 0
               ShapeAxisUnit = 1000
               ShapeGapFillName = ''
               InterpMethod = 2
            ...
            [StorageCoef]
               Touched = 1
               IsDataUsedInSetup = 1
               FixedValue = __sz_GeoLayersSZ_Layer_1_StorageCoef__
               Type = 0
               ShapeAxisUnit = 1000
               ShapeGapFillName = ''
               InterpMethod = 2
      ...
      [Drainage]
         ...
         [Level]
            Touched = 1
            IsDataUsedInSetup = 1
            FixedValue = __sz_Drainage_Level__
            Type = 0
            ShapeAxisUnit = 1000
            ShapeGapFillName = ''
            InterpMethod = 2
